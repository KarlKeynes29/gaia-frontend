...
export const Register: React.FC = () => {
    ...
    return (
        <div className="relative mx-auto m-0 top-20 bg-surface w-150 max-w-2xl min-h-fit p-8 border border-border rounded shadow-[0_0_15px_rgba(50,27,99,0.5)] transition-all">
